...
| `elevenlabs-config` | Modify ElevenLabs voice agent configuration: TTS model, speed, stability, soft timeout, first message, agent sync | [`skills/elevenlabs-config/SKILL.md`](skills/elevenlabs-config/SKILL.md) |
